...
# Identify date columns (exclude 'team_name', 'player_name', 'Lanzamientos Totales')
...
# Since the data is in strings, compare to '0' instead of 0
...
non_date_columns = ['player_name', 'Lanzamientos Totales']
